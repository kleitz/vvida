angular.module('vvida.controllers')
  .controller('ProfileCtrl', ['$rootScope', '$scope', '$state', 'Users', 'Utils',
    function($rootScope, $scope, $state, Users, Utils) {
      if ($rootScope.currentUser) {
        Users.countries(function(err, res){
          ...
          $scope.countries = [{name: 'No countries available'}];
        }
        });
        $scope.user = {};
        ...
        $scope.editProfile = function() {
          ...
          if (!$rootScope.currentUser) {
            ...
            Users.update($scope.user, function(res) {
              ...
              $scope.message = 'You have successfully updated your profile. Click on the home button to get to vvida homepage';
            }, function(err) {
